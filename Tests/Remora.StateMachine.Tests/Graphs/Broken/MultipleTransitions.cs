//
//  SPDX-FileName: MultipleTransitions.cs
...
/// <summary>
/// Contains the definitions for a broken graph that attempts to transition to another state multiple times.
/// </summary>
public static class MultipleTransitions
{
